...
public class HttpClientUtils {
    ...
    public static String doPost(String uri, Map<String, String> params) {
        String responseBody; HttpPost httpPost = new HttpPost(uri);
        try {
         ...
         ResponseHandler<String> responseHandler = new ResponseHandler<String>()
         {
             ...
             public String handleResponse(final HttpResponse response) throws IOException {
                 ...
                 if (status >= HttpStatus.SC_OK && status < HttpStatus.SC_MULTIPLE_CHOICES) {
                     ...
                     EntityUtils.consume(entity); return result;
                 } else {
     ...
     */ SocketConfig socketConfig = SocketConfig.custom()
     ...
     connManager.setMaxTotal(MAX_TOTAL_CONNECTIONS); return connManager;
     }
}
